...
def body_coord_sys(snap, particle_id, side_id, N_p, vpp, box_size, plotParticle=False):
  ...
  side1_positions = (get_side_positions(int_side1_types))%(box_size)
  side2_positions = (get_side_positions(int_side2_types))%(box_size)
  side3_positions = (get_side_positions(int_side3_types))%(box_size)
